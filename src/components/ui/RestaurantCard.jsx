...
const RestaurantCard = ({ image, rating, restaurant, address, id }) => {
  return (
    <div className='rounded-[20px] w-[260px] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] cursor-pointer'>
      <div
      ...
      <div className='bg-[#F0F1F2] py-3 px-4 w-full text-center flex flex-col rounded-b-3xl text-primaryText'>
