...
import ShowDeleteConfirmation from '../../components/common/showDeleteConfirmation.jsx'
      ...
      <div className='relative mx-5 my-2 px-3 py-4'>
        <div className='flex justify-between mb-3'>
          <h3 className='text-3xl font-[700] font-family color-1 text-left mb-4 '>
            Welcome Manage Items 👋
          </h3>
          <button
            onClick={() => handleCreateItem()}
            className=' bg-[#0d6efd] text-white font-bold rounded-md px-3 '
          >
            Add new Product
          </button>
        </div>
                ...
                <tr className=''>
                  ...
                  <td className=' '>
                    ...
                    <button
                      ...
                      className='px-2 py-1  rounded-sm bg-[#ffc107] mr-2'
                    >
                      Edit
                    </button>
                    ...
                    <tr key={item._id} id={item._id}>
                      ...
                      <td className=''>
                        ...
                        <button
                          ...
                          className='px-2 py-1 rounded-sm bg-[#dc3545]'
                        >
                          Delete
                        </button>
                      </td>
